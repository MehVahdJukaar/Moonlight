...
public class ModLootConditions {
    ...
    public record IConditionLootCondition(List<ICondition> conditions) implements LootItemCondition {
        ...
        public static final Codec<IConditionLootCondition> CODEC =  RecordCodecBuilder.create((i) -> i.group(
    ...
    public record PatternMatchCondition(List<Pattern> patterns) implements LootItemCondition {
        ...
        public static final Codec<PatternMatchCondition> CODEC =  RecordCodecBuilder.create((i) -> i.group(
