...
public class ModLootConditions {
    ...
    public static final Supplier<LootItemConditionType> PATTERN_MATCH_CONDITION = RegHelper.register(Moonlight.res("loot_table_id_pattern"),
            () -> new LootItemConditionType(new PatternMatchCondition .ConditionSerializer()), Registry.LOOT_CONDITION_TYPE);
