...
public class TextureUtilsExample {
    ...
    public static TextureImage createRecoloredTexture(ResourceManager manager) {
        ...
        try (TextureImage stone = TextureImage.open(manager, Identifier.parse("block/stone"));
             TextureImage deepslate = TextureImage.open(manager, Identifier.parse("block/deepslate"))) {
    ...
    public static TextureImage createTransformedTexture(ResourceManager manager) {
        ...
        try {
            ...
            Identifier diamondRes = RPUtils.findFirstBlockTextureLocation(manager, Blocks.DIAMOND_BLOCK);
            try (TextureImage diamond = TextureImage.open(manager, diamondRes);
                 TextureImage pick = TextureImage.open(manager, Identifier.parse("item/diamond_pickaxe"));
                 TextureImage emerald = TextureImage.open(manager, Identifier.parse("block/emerald"))) {
