...
public abstract class SoftFluid {
    ...
    protected SoftFluid(Builder builder) {
    ...
    @Nullable
    @ExpectPlatform
    private static Triplet<ResourceLocation,ResourceLocation, Integer> getRenderingData(ResourceLocation useTexturesFrom){
        return null;
    }
    ...
    @ExpectPlatform
    public static SoftFluid createInstance(Builder builder){
        throw new AssertionError();
    }

    @ExpectPlatform
    private static void addFluidParam(Builder builder, Fluid fluid) {
        throw new AssertionError();
    }
    ...
    public enum TintMethod implements StringRepresentable {
        ...
        public static final Codec<TintMethod> CODEC = StringRepresentable.fromEnum(TintMethod::values, TintMethod::valueOf);
    ...
    private static final SoftFluid DEFAULT_DUMMY = new Builder(new ResourceLocation(""), new ResourceLocation("")).build();
