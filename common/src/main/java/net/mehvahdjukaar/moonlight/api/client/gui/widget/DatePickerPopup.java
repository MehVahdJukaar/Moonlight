...
public class DatePickerPopup extends AnchoredPopup {
    ...
    protected void renderContent(GuiGraphics graphics, int x, int y, int mouseX, int mouseY) {
        ...
        graphics.drawCenteredString(font, "<", x + PAD + CELL_W / 2, textY, overPrev ? TEXT : DESCRIPTION);
        graphics.drawCenteredString(font, ">", x + width - PAD - CELL_W / 2, textY, overNext ? TEXT : DESCRIPTION);
