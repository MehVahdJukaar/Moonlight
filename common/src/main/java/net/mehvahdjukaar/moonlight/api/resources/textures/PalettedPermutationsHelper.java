...
public final class PalettedPermutationsHelper {
    ...
    @Nullable
    public static TextureImage tryResolveImage(ResourceManager manager, ResourceLocation spriteId) {
    ...
    private static Map<ResourceLocation, PalettedSprite> scanPalettedSprites(ResourceManager manager) {
        Map<ResourceLocation, PalettedSprite> map = new HashMap<>();
    ...
    private static void addPermutations(PalettedPermutations source, Map<ResourceLocation, PalettedSprite> map) {
        for (var perm : source.permutations.entrySet()) {
            String suffix = "_" + perm.getKey();
            for (ResourceLocation base : source.textures) {
