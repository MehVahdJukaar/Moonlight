...
public interface IFirstPersonAnimationProvider {
    ...
    default void animateItemFirstPerson(final AbstractClientPlayer entity, final ItemStack stack, final InteractionHand hand, final PoseStack poseStack,
                                float partialTicks, float pitch, float attackAnim, float handHeight){
        animateItemFirstPerson((LivingEntity) entity, stack, hand,poseStack, partialTicks, pitch, attackAnim, handHeight);
    }
