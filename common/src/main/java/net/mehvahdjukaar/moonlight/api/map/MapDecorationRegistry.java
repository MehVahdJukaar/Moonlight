...
public class MapDecorationRegistry extends SimpleJsonResourceReloadListener {
    ...
    //instance for the json reload listener
    private MapDecorationRegistry() {
    ...
    /**
     * registers a decoration type. use to register simple for decoration that doesn't need a world marker
     *
