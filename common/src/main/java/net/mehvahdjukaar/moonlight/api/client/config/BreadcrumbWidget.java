...
import static net.mehvahdjukaar.moonlight.api.client.gui.ConfigGuiColors.CRUMB;
import static net.mehvahdjukaar.moonlight.api.client.gui.ConfigGuiColors.CRUMB_CURRENT;
import static net.mehvahdjukaar.moonlight.api.client.gui.ConfigGuiColors.CRUMB_HOVER;
import static net.mehvahdjukaar.moonlight.api.client.gui.ConfigGuiColors.CRUMB_SEPARATOR;
...
class BreadcrumbWidget extends AbstractWidget {
    ...
    BreadcrumbWidget(int x, int y, int width, int height, Font font, List<Crumb> crumbs, Consumer<Screen> onNavigate) {
