...
public class VanillaWoodTypes {
    ...
    public static final WoodType OAK = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("oak"), Blocks.OAK_PLANKS, Blocks.OAK_LOG));
    public static final WoodType SPRUCE = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("spruce"), Blocks.SPRUCE_PLANKS, Blocks.SPRUCE_LOG));
    public static final WoodType BIRCH = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("birch"), Blocks.BIRCH_PLANKS, Blocks.BIRCH_LOG));
    public static final WoodType JUNGLE = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("jungle"), Blocks.JUNGLE_PLANKS, Blocks.JUNGLE_LOG));
    public static final WoodType ACACIA = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("acacia"), Blocks.ACACIA_PLANKS, Blocks.ACACIA_LOG));
    public static final WoodType CHERRY = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("cherry"), Blocks.CHERRY_PLANKS, Blocks.CHERRY_LOG));
    public static final WoodType DARK_OAK = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("dark_oak"), Blocks.DARK_OAK_PLANKS, Blocks.DARK_OAK_LOG));
    public static final WoodType MANGROVE = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("mangrove"), Blocks.MANGROVE_PLANKS, Blocks.MANGROVE_LOG));
    public static final WoodType BAMBOO = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("bamboo"), Blocks.BAMBOO_PLANKS, Blocks.BAMBOO_BLOCK));
    public static final WoodType CRIMSON = WoodTypeRegistry.INSTANCE.register(
            new WoodType(new ResourceLocation("crimson"), Blocks.CRIMSON_PLANKS, Blocks.CRIMSON_STEM));
