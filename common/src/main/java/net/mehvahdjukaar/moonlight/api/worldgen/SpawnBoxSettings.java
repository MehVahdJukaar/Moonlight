...
public record SpawnBoxSettings(
        Map<MobCategory, Map<String, WeightedList<MobSpawnSettings.SpawnerData>>> spawnOverrides) {

    private record Entry(MobCategory category, String name, WeightedList<MobSpawnSettings.SpawnerData> spawns) {
        public static final Codec<Entry> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                ...
                WeightedList.codec(MobSpawnSettings.SpawnerData.CODEC).fieldOf("spawns").forGetter(Entry::spawns)
    ...
    private static DataResult<SpawnBoxSettings> fromEntries(List<Entry> entries) {
        Map<MobCategory, Map<String, WeightedList<MobSpawnSettings.SpawnerData>>> map = new HashMap<>();
        for (Entry e : entries) {
    ...
    public WeightedList<MobSpawnSettings.SpawnerData> get(String boxID, MobCategory category) {
