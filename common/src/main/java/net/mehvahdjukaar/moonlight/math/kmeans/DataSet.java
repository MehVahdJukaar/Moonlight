...
import net.mehvahdjukaar.moonlight.client.textures.PaletteColor;
import net.mehvahdjukaar.moonlight.math.colors.BaseColor;
import net.mehvahdjukaar.moonlight.math.colors.LABColor;
