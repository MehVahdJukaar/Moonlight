...
public abstract class TeleportCommandMixin {
    ...
    private static boolean ml$captureOldTpPos(Entity instance, ServerLevel level, double x, double y, double z, Set<RelativeMovement> relativeMovements, float yRot, float xRot, Operation<Boolean> original) {
        BlockPos oldPos = instance.blockPosition();
        var oldDim = instance.level().dimension();
        boolean result = original.call(instance, level, x, y, z, relativeMovements, yRot, xRot);
