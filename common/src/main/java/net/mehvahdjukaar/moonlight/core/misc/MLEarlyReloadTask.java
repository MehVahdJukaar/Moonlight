...
public class MLEarlyReloadTask {
    ...
    private static class WrapperInstance implements ReloadInstance {
        ...
        @Nullable
        private ReloadInstance getOrCreateInstanceIfTaskDone() {
        ...
        public CompletableFuture<?> done() {
            return beforeTask.thenCompose(unused -> {
                ReloadInstance actual = getOrCreateInstanceIfTaskDone();
                return actual.done();
            });
        }
