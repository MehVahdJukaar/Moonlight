...
public class OptionalItemPoolEntry extends LootPoolSingletonContainer {
    ...
    public static final MapCodec<OptionalItemPoolEntry> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
            Codec.STRING.fieldOf("name").forGetter(o -> o.tagOrItemId)
    ).and(singletonFields(instance)).apply(instance, OptionalItemPoolEntry::new));
